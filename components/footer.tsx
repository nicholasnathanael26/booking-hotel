  ...
  return (
    <footer className="bg-gray-900">
            ...
            <div className="grid md:grid-cols-3 gap-7">
                <div>
                    ...
                    <p className="text-gray-400">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit nostrum non mollitia repellat? Cumque, ullam.
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <form action="" className="mt-5 ">
                        <div className="mb-5">
                            <input type="text" name="email" className="w-full p-3 rounded-sm bg-white" placeholder="johndoe@gmail.com" />
                        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
            &copy; Copyright 2025 | Nicholas N W | All Right Reserved
        </div>
    </footer>
  )
}
